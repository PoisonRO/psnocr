...
${OBJECTDIR}/app_settings.o: app_settings.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/app_settings.o app_settings.cpp
...
${OBJECTDIR}/ocr_parser.o: ocr_parser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ocr_parser.o ocr_parser.cpp

${OBJECTDIR}/ocr_region.o: ocr_region.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ocr_region.o ocr_region.cpp

${OBJECTDIR}/ocr_region_process.o: ocr_region_process.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ocr_region_process.o ocr_region_process.cpp

${OBJECTDIR}/ocr_regionoperation.o: ocr_regionoperation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ocr_regionoperation.o ocr_regionoperation.cpp

${OBJECTDIR}/ocr_regionvalidator.o: ocr_regionvalidator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ocr_regionvalidator.o ocr_regionvalidator.cpp
